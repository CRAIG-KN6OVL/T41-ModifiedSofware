...
const char *topMenus[] = { "Bearing", "CW Options", "RF Set", "VFO Select",
                           ...
                           "EQ Rec Set", "EQ Xmt Set", "Calibrate", "Time"}; /*** 11-22-2025 CMA KN6OVL added Menu Item "Time" for setting system time and RTC ***/
...
int (*functionPtr[])() = { &BearingMaps, &CWOptions, &RFOptions, &VFOSelect,
                           ...
                           &EqualizerRecOptions, &EqualizerXmtOptions, &IQOptions,&TSOptions
