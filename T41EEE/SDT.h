...
#define VERSION "T41EEE6R1"        // Change this for updates. If you make this longer than 9 characters, brace yourself for surprises.  Use quotes!
/** T41EEE.6R IS MY MODIFIED VERSION TO TEST SETTING THE RTC TO SOMETHING OTHER THAN COMPILE TIME **/
...
#define TOP_MENU_COUNT 14      // Menus to process AFP 09-27-22, JJP 7-8-23  11-22-25 CMA KN60VL INCREASED VALUE TO 14 TO ADD SET TIME OPTION
...
struct config_t {
  ...
  int switchValues[18] = { 868, 820, 773,
                           724, 677, 634,
                           582, 533, 487,
                           438, 387, 339,
                           287, 235, 182,
                           126, 63, 2 };    // 11/21/2025 CMA changed these values to reflect my T41 hardware.
