...
#define MAP_FILE_NAME   					"CostaMesa.bmp"                          // Name you gave to BMP map file. Max is 50 chars
#define MY_LAT										33.6941                                  // Coordinates for QTH
#define MY_LON										-117.8991
#define MY_CALL										"KN6OVL"                                   // Default max is 10 chars
...
#define PADDLE_FLIP								1						                              // 0 = right paddle = DAH, 1 = DIT
#define STRAIGHT_KEY_OR_PADDLES		1						                              // 0 = straight, 1 = paddles
