...
const char *topMenus[] = { "CW Options", "RF Set", "VFO Select",
                           ...
                           "EQ Rec Set", "EQ Xmt Set", "Calibrate", "Bearing", "Time"}; /*** 11-22-2025 CMA KN6OVL added Menu Item "Time" for setting system time and RTC ***/
...
void (*functionPtr[])() = { &CWOptions, &RFOptions, &VFOSelect,
                            ...
                            &EqualizerRecOptions, &EqualizerXmtOptions, &CalibrateOptions, &BearingMaps, &TSOptions};
...
FLASHMEM void setup() {
  ...
  setTime(now());
 // setTime(23,55,00,18,11,2025); //Set system time to 23:55:00 Nov 18, 2025 as a test. If this works, want to use a new menu item to set the time.
   // 11-20-25 setTime worked
  Teensy3Clock.set(now());  // set the RTC
  T4_rtc_set(Teensy3Clock.get()); // from what I can tell, T4_rtc_set code is commented out due to a #if 0 statement
